...
displayMonth=function displayMonth(a){var b=a.info,c=a.graphic,d=b.active,e=b.rangeStart,f=b.rangeEnd,g=b.weekStartingDay,h=b.highlight,k=b.highlightClasses,m=b.showInactiveMonths,n=c.monthStr,o=c.yearStr,p=c.dateElements,q=c.container,r=c.prevMonth,s=c.nextMonth,t=c.prevYear,u=c.nextYear,v=d.month,w=d.year,x=h&&h[w]&&h[w][v],y=new Date(v+'/1/'+w),z=y.getDay(),A=b.startingPos=z-g+(g<=z?0:7),B=daysInMonth[v-1]+(checkLeapYear(w)&&2===v?1:0),C=p.length,D=validateActiveStart({day:1,month:v,year:w},e),E=validateActiveEnd({day:B,month:v,year:w},f),F=D?0:e.month===v&&e.year===w?e.day-1:B,G=E?B+1:e.month===v&&e.year===w?f.day+1:1,H=void 0,I=void 0,J=void 0,K=void 0;// remove previously applied Classes
